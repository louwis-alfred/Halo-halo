...
import { listProducts, addProduct, singleProduct, removeProduct, updateProduct, getSellerProducts, soonToBeHarvestedProducts } from '../controllers/productController.js';
...
productRouter.post('/add', authUser, authSeller, uploadProductImages.fields([
...
productRouter.get('/soon-to-be-harvested', soonToBeHarvestedProducts); // Add this line
